extern int __trace_condition(const char*, int, int);
extern int __trace_function(const char*);
extern int __trace_switch(const char*, int, int);
# 1 "/home/kmohr/rot13_echo/server.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 361 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/kmohr/rot13_echo/server.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 2 "/home/kmohr/rot13_echo/server.c" 2
...
// Begin function __bswap_16 returning __uint16_t
static __inline __uint16_t
__bswap_16 (__uint16_t __bsx)
{__trace_function("__bswap_16");
...
// Begin function __bswap_32 returning __uint32_t
static __inline __uint32_t
__bswap_32 (__uint32_t __bsx)
{__trace_function("__bswap_32");
...
// End function __bswap_32
# 69 "/usr/include/x86_64-linux-gnu/bits/byteswap.h" 3 4
__extension__ // Begin function __bswap_64 returning __uint64_t
static __inline __uint64_t
__bswap_64 (__uint64_t __bsx)
{__trace_function("__bswap_64");
...
// End function __bswap_64
# 36 "/usr/include/endian.h" 2 3 4
# 1 "/usr/include/x86_64-linux-gnu/bits/uintn-identity.h" 1 3 4
# 32 "/usr/include/x86_64-linux-gnu/bits/uintn-identity.h" 3 4
// Begin function __uint16_identity returning __uint16_t
static __inline __uint16_t
__uint16_identity (__uint16_t __x)
{__trace_function("__uint16_identity");
  return __x;
}
// End function __uint16_identity

// Begin function __uint32_identity returning __uint32_t
static __inline __uint32_t
__uint32_identity (__uint32_t __x)
{__trace_function("__uint32_identity");
  return __x;
}
// End function __uint32_identity

// Begin function __uint64_identity returning __uint64_t
static __inline __uint64_t
__uint64_identity (__uint64_t __x)
{__trace_function("__uint64_identity");
  return __x;
}
// End function __uint64_identity
...
# 3 "/home/kmohr/rot13_echo/server.c" 2
...
# 4 "/home/kmohr/rot13_echo/server.c" 2
...
# 5 "/home/kmohr/rot13_echo/server.c" 2
...
// Begin function handle_request returning int
int handle_request(struct handle_request_t* req) {__trace_function("handle_request");
    char buffer[2048];

    int n = recvfrom(req->sockfd, buffer, sizeof(buffer), 0, (struct sockaddr*) (req->clientaddr), &req->clientlen);
    if (__trace_condition("handle_request", 0, (n < 0) && 1)) {
        return -1;
    }

    if (__trace_condition("handle_request", 1, (buffer[0] == '?') && 1)) {
        for (int i = 0; i < n; i++) {
            if (__trace_condition("handle_request", 2, (buffer[i] >= 'A' && buffer[i] <= 'Z') && 1)) {
                buffer[i] = 'A' + (buffer[i] - 'A' + 13) % 26;
            } else if (__trace_condition("handle_request", 3, (buffer[i] >= 'a' && buffer[i] <= 'z') && 1)) {
                buffer[i] = 'a' + (buffer[i] - 'a' + 13) % 26;
            }
        }
    }

    n = sendto(req->sockfd, buffer, n, 0, (struct sockaddr*) (req->clientaddr), req->clientlen);
    if (__trace_condition("handle_request", 4, (n < 0) && 1)) {
        return -1;
    }
...
int main(int argc, char* argv[]) {__trace_function("main");
    int sockfd;
    struct sockaddr_in servaddr;
    if (__trace_condition("main", 0, ((sockfd = socket(2, SOCK_DGRAM, 0)) < 0) && 1)) {
        return -1;
    }

    int optval = 1;
    setsockopt(sockfd, 1, 2, (const void*)&optval, sizeof(int));

    memset(&servaddr, 0, sizeof(servaddr));
    servaddr.sin_family = 2;
    servaddr.sin_addr.s_addr = htonl(((in_addr_t) 0x00000000));
    servaddr.sin_port = htons((unsigned short)(31850));

    if (__trace_condition("main", 1, (bind(sockfd, (struct sockaddr*) &servaddr, sizeof(servaddr)) < 0) && 1))
        return -1;

    struct sockaddr_in clientaddr;
    int clientlen = sizeof(clientaddr);

    struct handle_request_t req = {sockfd, &clientaddr, clientlen};

    while(1) {
        __trace_begin("handle_request");
        int res = handle_request(&req);
        __trace_end();
        if (__trace_condition("main", 2, (res < 0) && 1)) {
            return -1;
        }
    }
